function [coocurMatrix, coocurMatrixAdj, growthMatrix, ...
            ...
            variable, growth, varPresence, type, minPresence, method)
...
%
% USAGE
%   [coocurranceMatrix, coocurranceMatrixAdj, growthMatrix, ...
%       varPresenceLabel, uniqueModels] = tncore_matrix(model, variable,...
%       growth, varPresence, type)
%
% INPUTS
...
%                       model generation. Use 1 for FBA and 2 for MOMA 
%                       (Default = 1)
%
% OUTPUTS
