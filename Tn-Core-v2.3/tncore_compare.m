...
% reaction between core model populations produced from independent runs of
% tncore_redundancy.
%
% USAGE
%   [varPresenceMatrix] = tncore_compare(varNames, varPresenceArray, ...
%       headers);
%
% INPUTS
%   varNames            A cell array of the variable names in the same 
